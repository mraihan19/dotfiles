...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1614578122);
user_pref("app.update.lastUpdateTime.background-update-timer", 1614578438);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1614578242);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1614621202);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1614578558);
user_pref("browser.cache.disk.capacity", 358400);
user_pref("browser.cache.disk.filesystem_reported", 1);
user_pref("browser.dom.window.dump.enabled", false);
user_pref("extensions.blocklist.pingCountVersion", 0);
user_pref("extensions.databaseSchema", 27);
user_pref("extensions.lastAppBuildId", "20210111155113");
user_pref("extensions.lastAppVersion", "5.0.95");
user_pref("extensions.lastPlatformVersion", "60.9.0");
user_pref("extensions.pendingOperations", false);
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.zotero.dataDir", "/home/n30/Zotero");
